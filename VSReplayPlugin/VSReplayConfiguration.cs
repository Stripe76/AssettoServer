...
public class VSReplayConfiguration : IValidateConfiguration<VSReplayConfigurationValidator>
{
    ...
    [YamlMember(Description = "Starting frame of the replay, to skip a part")]
    public int StartFrame { get; init; } = 0;

    [YamlMember( Description = "Looping lap number" )]
    public int LoopLap { get; init; } = 1;

    [YamlMember( Description = "Starting frame for the looping part, if greater than 0 will override the lap setting" )]
    public int LoopStart { get; init; } = 0;
    [YamlMember( Description = "Ending frame for the looping part" )]
    ...
    [YamlMember( Description = "Could improve car twitching" )]
    public bool ReplayTimestamp { get; init; } = false;
}
